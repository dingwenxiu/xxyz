 ...
 */
class CronTrace extends Command {

    protected $signature    = 'tool:cron_trace {action}';
    ...
    public function __construct() {
        parent::__construct();
        $this->tpl    = __DIR__ . '/tpl/cron_trace.tpl.php';
        $this->path   = __DIR__ . '/../Runtime/';
        $this->file   = $this->path . 'cron_trace.conf';

        $md5 = md5(config('app.name'));
        $this->startMark =   'start_mark_trace_' . $md5;
        $this->endMark   =   'end_mark_trace_' . $md5;
    }
