 ...
 */
class CronStat extends Command {

    protected $signature    = 'tool:cron_stat {action}';
    ...
    public function __construct() {
        parent::__construct();
        $this->tpl    = __DIR__ . '/tpl/cron_stat.tpl.php';
        $this->path   = __DIR__ . '/../Runtime/';
        $this->file   = $this->path . 'cron_stat.conf';

        $md5 = md5(config('app.name'));
        $this->startMark =   'start_mark_stat_' . $md5;
        $this->endMark   =   'end_mark_stat_' . $md5;
    }
