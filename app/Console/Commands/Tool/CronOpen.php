 ...
 */
class CronOpen extends Command {

    protected $signature    = 'tool:cron_open {action}';
    ...
    public function __construct() {
        parent::__construct();
        $this->tpl    = __DIR__ . '/tpl/cron_open.tpl.php';
        $this->path   = __DIR__ . '/../Runtime/';
        $this->file   = $this->path . 'cron_open.conf';

        $md5 = md5(config('app.name'));
        $this->startMark =   'start_mark_open_' . $md5;
        $this->endMark   =   'end_mark_open_' . $md5;
    }
